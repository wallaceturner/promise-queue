...
(this, function () {
    ...
    var handleResult = function (queue, item, value, err, reject) {
        
        queue.pendingPromises--;
        if(item.timer && !item.timedout){            
        ...
        try {
            ...
            if(this.options.timeout){
                item.timer = setTimeout(()=>{               
                    item.timedout = true;                    
                    handleResult(self, item, null, 'message did not complete execution after timeout of '+ this.options.timeout, true)                
            ...
            // Forward all stuff
                .then(function (value) {
                    ...
                    handleResult(self, item, value, null);
                }, function (err) {
                    handleResult(self, item, null, err, true);
                }, function (message) {
